...
/**
 * Core session model used across the site.
 * Source of truth for agenda rendering.
 */
...
export type Session = {
  ...
  day: string          // YYYY-MM-DD (derived from start)
  track: string
  room?: string
  speakers?: Speaker[]
  isBreak?: boolean
 ...
 * Useful if you want consistent labels, colours, or icons.
 */
...
/**
 * Optional: Centralised event config
 */
